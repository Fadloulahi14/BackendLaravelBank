...
Route::middleware('cors')->group(function () {
    ...
    Route::post('auth', [\App\Http\Controllers\LoginController::class, 'login']);
    Route::post('clients/new_password
', [\App\Http\Controllers\AuthController::class, 'changePassword'])->middleware('auth:api');
