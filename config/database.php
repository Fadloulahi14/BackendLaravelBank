    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'port' => is_numeric(env('DB_PORT')) ? (int) env('DB_PORT') : 3306,
        ...
        'pgsql' => [
            ...
            'options' => extension_loaded('pdo_pgsql') ? array_filter([
                // Emuler les prepared statements pour éviter l'erreur "cached plan must not change result type"
        ...
        'neon_buffer' => [
            ...
            'url' => env('NEON_BUFFER_URL', 'postgresql://neondb_owner:npg_RXfPQCyacT84@ep-proud-sky-adxnf5xb-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'),
        ...
        'sqlsrv' => [
            ...
            'port' => is_numeric(env('DB_PORT')) ? (int) env('DB_PORT') : 1433,
            'database' => env('DB_DATABASE', 'laravel'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => env('DB_CHARSET', 'utf8'),
        ...
        // MongoDB connection (used to store transaction copies)
        'mongodb' => [
            'driver' => 'mongodb',
            'dsn' => env('MONGO_URI'),
            'database' => env('MONGO_DB', 'transaction'),
        ],
    ],
